...
#[derive(Debug)]
pub struct Vec6<T, const S: usize, const B: usize> {
    pub(crate) val: Vector6<T>,
}

impl<T, const S: usize, const B: usize> Mul<T> for Vec6<T, S, B>
where
    T: Copy + RealField,
{
    type Output = Self;
...
impl<T, const S: usize, const B: usize> Vec6<T, S, B>
where
    T: Copy,
{
...
impl<T, const S: usize, const B: usize> Vector for Vec6<T, S, B>
where
    T: Copy,
{
